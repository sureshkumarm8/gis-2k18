...
public class PersonDBHelper extends SQLiteOpenHelper {
    ...
    public void saveNewPerson(Person person) {
        ...
        values.put(COLUMN_PERSON_AGE, person.getStroyurl());
        values.put(COLUMN_PERSON_OCCUPATION, person.getTitle());
    ...
    public List<Person> peopleList(String filter) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                person.setStroyurl(cursor.getString(cursor.getColumnIndex(COLUMN_PERSON_AGE)));
                person.setTitle(cursor.getString(cursor.getColumnIndex(COLUMN_PERSON_OCCUPATION)));
    ...
    public Person getPerson(long id){
        ...
        if(cursor.getCount() > 0) {
            ...
            receivedPerson.setStroyurl(cursor.getString(cursor.getColumnIndex(COLUMN_PERSON_AGE)));
            receivedPerson.setTitle(cursor.getString(cursor.getColumnIndex(COLUMN_PERSON_OCCUPATION)));
    ...
    public void updatePersonRecord(long personId, Context context, Person updatedperson) {
        ...
        db.execSQL("UPDATE  "+TABLE_NAME+" SET name ='"+ updatedperson.getName() + "', age ='" + updatedperson.getStroyurl()+ "', occupation ='"+ updatedperson.getTitle() + "', image ='"+ updatedperson.getImage() + "'  WHERE _id='" + personId + "'");
