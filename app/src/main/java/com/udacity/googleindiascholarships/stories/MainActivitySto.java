...
import com.udacity.googleindiascholarships.stories.Utils.PersonAdapter;
import com.udacity.googleindiascholarships.stories.Utils.PersonDBHelper;

public class MainActivitySto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainsto);
    ...
    private void goToAddUserActivity(){
        Intent intent = new Intent(MainActivitySto.this, AddRecordActivity.class);
